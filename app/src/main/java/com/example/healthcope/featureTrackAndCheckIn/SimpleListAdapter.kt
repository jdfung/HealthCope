...
class SimpleListAdapter(private val context : Activity, private val topicList : ArrayList<String>) : ArrayAdapter<String>(context,
    R.layout.simple_list_item, topicList) {
